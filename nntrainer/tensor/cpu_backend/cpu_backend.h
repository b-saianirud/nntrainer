 ...
 */
extern size_t nntr_get_rhs_packed_size_qsi4cxp_qs4cxs1s0(size_t n, size_t k,
 ...
 */
extern void nntr_qsi4cxp_qs4cxs1s0_rhs_pack(size_t n, size_t k,
...
extern uint32_t nntr_gemm_qai8dxp_qsi4cxp_unpacked(
 ...
 */
template <typename T = float>
extern void nntr_gemm_qai8dxp_qsi4cxp_packed(
 ...
 */
template <typename T = float>
extern void calc_trigonometric_vals_dup(unsigned int N_half, T *angle, T *cos_,
 ...
 * @param[in/out] qk_out _FP16* input/output values
 * @param[in] start_row start row number
 * @param[in] end_row end row number
 * @param[in] num_heads heads number
